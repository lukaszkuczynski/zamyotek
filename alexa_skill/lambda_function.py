...
class BringMeIntentHandler(AbstractRequestHandler):
    """Handler for bringme Intent."""
    def can_handle(self, handler_input):
        # type: (HandlerInput) -> bool
        return ask_utils.is_intent_name("bring_me")(handler_input)
...
class CatchAllExceptionHandler(AbstractExceptionHandler):
    ...
    def handle(self, handler_input, exception):
        ...
        speak_output = "Sorry, Error occurred."
...
sb.add_request_handler(BringMeIntentHandler())
