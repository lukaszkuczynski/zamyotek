sensor_node_pid := $(shell ps -au | grep sensor_node | grep -v grep | cut -f2 -d' ')
camera_node_pid := $(shell ps -au | grep camera.py | grep -v grep | cut -f2 -d' ')
brain_node_pid := $(shell ps -au | grep brain.py | grep -v grep | cut -f2 -d' ')
motor_node_pid := $(shell ps -au | grep motor_mqtt_node.py | grep -v grep | cut -f2 -d' ')
servo_node_pid := $(shell ps -au | grep servo_mqtt_node.py | grep -v grep | cut -f2 -d' ')
